...
public class SplitStarAnimView extends FrameLayout {
    ...
    public SplitStarAnimView(@NonNull Context context) {
        this(context,null);
        this.mContext = context;
    }

    public SplitStarAnimView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
        this.mContext = context;
    }

    public SplitStarAnimView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    private Runnable starStartRunnable = new Runnable() {
        ...
        public void run() {
            ...
            mHandler.postDelayed(starStartRunnable,50);
        }
    };
